...
class CreateMarkingPlatinumTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('marking_platinum', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('marking_platinum');
    }
}
